...
export const translations = {
  en: {
    ...
    clientMemory: {
      ...
      placeholders: {
        ...
        approval: "e.g. Explicit email OK, verbal signoff, needs PDF review form...",
        revision: "Expected feedback style (e.g., detail-oriented, requests layout changes late, minimal edits needed)...",
        feedback: "Recurring feedback patterns or preferences (e.g. Dislikes pastel colors, always wants larger text)...",
        boundary: "Notes on scope limits and how client responds to extra revision pricing...",
        payTiming: "e.g. Net 15, same day, 1 week late...",
        payBehavior: "e.g. Requires follow-up, fast payer, ignores first invoice but pays on reminder...",
        payNotes: "Bank preferences, specific tax numbers, invoice processing delays context...",
        filePref: "e.g. Figma source, SVG, MP4, PDF print-ready...",
        folderPref: "e.g. Google Drive link, GitHub PR, WeTransfer...",
        ...
        relationship: "Personal context, how we met, references to check...",
  ...
  id: {
    ...
    clientMemory: {
      ...
      paymentReminderStyle: "Gaya Pengingat Payment",
      ...
      lastProjectSummary: "Ringkasan Project Terakhir",
      lastMeetingSummary: "Ringkasan Rapat Terakhir",
      clientVisibleNotes: "Catatan Terlihat Client",
      ...
      placeholders: {
        ...
        approval: "contoh: persetujuan via email, verbal signoff, butuh form PDF...",
        revision: "Pola feedback (contoh: sangat detail, minta ubah layout di akhir, butuh sedikit revisi)...",
        feedback: "Feedback yang sering muncul (contoh: tidak suka warna pastel, selalu minta teks lebih besar)...",
        boundary: "Batasan revisi dan respon client terhadap biaya revisi tambahan...",
        payTiming: "contoh: Net 15, hari yang sama, telat 1 minggu...",
        payBehavior: "contoh: butuh follow-up, pembayar cepat, bayar setelah diingatkan...",
        payNotes: "Preferensi bank, NPWP, konteks keterlambatan pembayaran...",
        filePref: "contoh: source Figma, SVG, MP4, PDF siap cetak...",
        folderPref: "contoh: link Google Drive, GitHub PR, WeTransfer...",
        ...
        relationship: "Konteks personal, cara bertemu, referensi kontak...",
