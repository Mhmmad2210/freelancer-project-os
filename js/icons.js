/* ==========================================================================
   FREELANCER PROJECT OS - SVG ICONS DICTIONARY MODULE
   ========================================================================== */
...
/**
 * Returns an SVG icon with customizable class and dimensions.
 * @param {string} name - Name of the icon
 * @param {string} [className] - Optional CSS classes
 * @param {number} [size] - Optional width/height override
 * @returns {string} - SVG markup
 */
export function getIcon(name, className = '', size = null) {
  let svg = ICONS[name] || '';
  if (!svg) return '';
